package com.example.samsungschoolproject.adapter.calendar;
...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CalendarViewHolder holder, int position) {
        ...
        if (date == null){
            ...
            if (repository.getPlannedWorkoutsByDate(date.toString()).size() > 0) holder.itemView.setBackgroundColor(Color.parseColor("#80BDECB6"));
